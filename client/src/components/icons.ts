/**
 * Centralized icon exports using direct imports for optimal tree-shaking
 * This ensures only the icons we use are included in the bundle
 */

// Using direct imports instead of barrel imports for better tree-shaking
